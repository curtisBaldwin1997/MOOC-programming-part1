...
public class RecipeSearch {
       ...
       public static void main(String[] args) {
        ...
        ArrayList<Recipie> recipes = readRecipesFromFile(file);       
    ...
    public static void processCommand(String command, ArrayList<Recipie> recipes, Scanner input) {
    ...
    public static void printRecipes(ArrayList<Recipie> recipes) {
        System.out.println("Recipes:");
        for (Recipie recipe : recipes) {
            System.out.println(recipe.toString());
        }
    }

    public static void findAndPrintRecipesByName(ArrayList<Recipie> recipes, Scanner input) {
    ...
    public static void findAndPrintRecipesByCookingTime(ArrayList<Recipie> recipes, Scanner input) {
    ...
    public static void findAndPrintRecipesByIngredient(ArrayList<Recipie> recipes, Scanner input) {
    ...
    public static ArrayList<Recipie> readRecipesFromFile(String filename) {
        ...
        try (Scanner fileReader = new Scanner(Paths.get(filename))) {
            while (fileReader.hasNextLine()) {
                ...
                if (!line.isEmpty()) {
                    ...
                    recipeParts.remove(0);
                    recipes.add(new Recipie(recipeName, recipeTime, recipeParts));
                    recipeParts.clear();
                }
            }
